 ...
 */
export const obtenerQuizPorCurso = async (cursoId, mostrarAlerta = () => {}) => {
  try {
 ...
 */
export const guardarQuiz = async (cursoId, preguntas, mostrarAlerta = () => {}) => {
  try {
 ...
 */
export const eliminarQuizPorCurso = async (cursoId, mostrarAlerta = () => {}) => {
  try {
