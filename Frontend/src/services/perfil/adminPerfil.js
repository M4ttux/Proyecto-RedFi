...
// ====== FUNCIONES ORIGINALES DE PERFIL ======
...
// NOTA: eliminarPerfilPorId reemplazado por eliminarUsuarioCompleto que maneja auth + archivos
...
// ====== FUNCIONES CONSOLIDADAS DE GESTIÓN ADMINISTRATIVA DE USUARIOS ======
 ...
 * @param {string} userId - ID del usuario
 * @returns {string} Nueva contraseña temporal
 */
export const restablecerContrasenaUsuario = async (userId) => {
  try {
    ...
    const nuevaContrasena = `Temp${contrasena}!`;
    ...
    console.error('Error en restablecerContrasenaUsuario:', error);
    throw error;
  }
};
